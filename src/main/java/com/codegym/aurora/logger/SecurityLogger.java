...
public class SecurityLogger {
    ...
    @Before("execution(public * com.codegym.aurora.security.*.*(..))")
    ...
    @After("execution(public * com.codegym.aurora.security.*.*(..))")
    ...
    @AfterThrowing(value = "execution(public * com.codegym.aurora.security.*.*(..))", throwing = "error")
